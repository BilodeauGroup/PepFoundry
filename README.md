...
- **Default:**  
  Loads the standard amino acid database used with the package:  
...
```
**Important:** 
The Excel file should adhere to the format and conventions defined in [amino_acids_library](pepfoundry/project/core/amino_acids_library.xlsx) with amino acids defined in the **CHUCKLES format**, including **Map Numbers**.  
...
For a full usage examples, please see the [examples_PepFoundry](examples.ipynb) notebook included in this repository.
